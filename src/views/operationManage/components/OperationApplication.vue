<template>
  <div>
    <el-dialog :visible="showDialog" title="常规申请计划单" fullscreen @close="closeDialog" append-to-body>
      <el-button
        type="text"
    ...
    >
      <el-form :model="linkListReqParams" class="page-search" ref="addFormRef" inline>
        <el-form-item label="申请类型:" prop="hospitalUuid" style="margin-right: 20px;">常规采购</el-form-item>
